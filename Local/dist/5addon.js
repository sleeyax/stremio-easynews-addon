...
builder.defineMetaHandler(async ({ id, config }) => {
    ...
    for (const file of files) {
        ...
        const fileDl = `${(0, utils_1.createStreamUrl)(results)}/${(0, utils_1.createStreamPath)(file)}|${(0, utils_1.createStreamAuth)(config)}`;
        videos.push({
            id: `${prefix}${file.sig}`,
            ...
            streams: [
                {
                    ...
                    behaviorHints: {
                        ...
                        proxyHeaders: {
                            request: {
                                Authorization: (0, utils_1.createBasic)(config.username, config.password),
                            },
                        },
                    },
                },
